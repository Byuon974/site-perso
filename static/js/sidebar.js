(function () {
  ...
  function openSidebar() {
    ...
    // Focus vers le premier lien de la sidebar pour la navigation clavier
    var firstFocusable = sidebar.querySelector('a, button, input, select, textarea, [tabindex]:not([tabindex="-1"])');
    if (firstFocusable) {
