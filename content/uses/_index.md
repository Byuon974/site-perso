...
- **Laptop** : ThinkPad E14 Gen 6 (Lenovo 21M3002BFR) sous **Artix Linux**, init OpenRC. Un terrain d'exploration pour découvrir ce qu'un Linux devient sans la colonne vertébrale qu'est systemd, comprendre ce que ce dernier prend en charge par défaut et ce qu'il faut remettre en place à la main quand il n'est plus là.
