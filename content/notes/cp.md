...
_Commande fondamentale de duplication de fichiers et répertoires dans les systèmes Unix/Linux_
_Création de snapshots, préparation de données pour export, isolation des transformations_
_Différences sémantiques clés avec `mv`, `rsync` et outils de synchronisation_
